...
⚡ NEW — 4 sampling presets with Qwen3.5's official recommended parameters, force-injected at llama.cpp API level: Instruct General · Instruct Reasoning · Thinking General · Thinking Precise
